...
<head>
    ...
    <base href="./">
    <title>Learn about Redd | The social currency.</title>
    <meta property="og:title" content="Learn about Redd | The social currency." />
    <meta name="twitter:title" content="Learn about Redd | The social currency." />
  ...
  <div class="content">
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-10-12 margin-top-4" data-lang="ru">  
          <ul class="flex flex-49 later equal">
            <li class="col-4-12">
              <div class="fix-4-12 ae-3">
                <img class="wide margin-bottom-1 ae-4" src="assets/img/Who-contentcreator.jpg" style="border-radius: 5px;" alt="Content Creator"/>
        ...
        <div class="fix-12-12">
          <ul class="flex verticalCenter later">
            ...
            <li class="col-7-12 left" data-lang="en">
              ...
              <a href="funding.html" class="button small red margin-left-0 margin-right-1 ae-5 fromCenter">Project Funding Page</a><a href="assets/doc/PoSV-v2-FAQ.pdf" class="button small white rounded crop margin-top-0 ae-5">Learn about POSV v2</a>
            </li>
            ...
            <li class="col-7-12 left" data-lang="de" style="display:none;">
              ...
              <a href="funding.html" class="button small red margin-left-0 margin-right-1 ae-5 fromCenter">Projektfinanzierungsseite</a><a href="assets/doc/PoSV-v2-FAQ.pdf" class="button small white rounded crop margin-top-0 ae-5">Erfahren Sie mehr über POSv2</a>
            </li>
            ...
            <li class="col-7-12 left" data-lang="ko" style="display:none;">
              ...
              <a href="funding.html" class="button small red margin-left-0 margin-right-1 ae-5 fromCenter">프로젝트 자금 지원 페이지</a><a href="assets/doc/PoSV-v2-FAQ.pdf" class="button small white rounded crop margin-top-0 ae-5">POSV v2에 대해 알아보기</a>
            </li>
            ...
            <li class="col-7-12 left" data-lang="ru" style="display:none;">
              ...
              <a href="funding.html" class="button small red margin-left-0 margin-right-1 ae-5 fromCenter">Страница финансирования проекта</a><a href="assets/doc/PoSV-v2-FAQ.pdf" class="button small white rounded crop margin-top-0 ae-5">Узнать о POSV v2</a>
            </li>
      ...
      <div class="wrap">
        ...
        <div class="fix-12-12 margin-top-4">
          <ul class="flex fixedSpaces later left">
            ...
            <li class="col-3-12 col-tablet-1-3 col-phone-1-1 padding-bottom-4">
              <div class="empty margin-bottom-2 noShadow ae-10"><a href="join.html"><img class="wide" src="assets/img/team-you.jpg" style="border-radius: 5px;" alt="Join Team Redd"/></a></div>
              <h4 class="smaller ae-10">This could be you!</h4>
              <div class="ae-10"><p class="small cropBottom opacity-8"><a href="join.html">Join Team Redd</a></p></div>
              <div class="ae-10">
...
<!-- Panel Bottom #12 -->
<!-- English language -->
<nav class="panel bottom exceptFirstSlide" data-lang="en">
  <div class="sections desktop">
...
<!-- Deutsch language -->
<nav class="panel bottom exceptFirstSlide" data-lang="de" style="display:none;">
  <div class="sections desktop">
...
<!-- Korean language -->
<nav class="panel bottom exceptFirstSlide" data-lang="ko" style="display:none;">
  <div class="sections desktop">
...
<!-- Russian language -->
<nav class="panel bottom exceptFirstSlide" data-lang="ru" style="display:none;">
  <div class="sections desktop">
