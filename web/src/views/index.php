        ...
        <div class="content">
            <div class="container toSlide-2 pointer">
                <div class="wrap">
                    ...
                    <!-- Bulgarian language -->
                    <div class="fix-10-12 hideForMobile" data-lang="bg" style="display:none;">   <!-- edited to: data-lang="bg" // Create "bg" in class "data-long" -->
                        <svg height="120" class="wide ae-1 fromCenter"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo-tagline-bg"></use></svg> <!-- "#logo-tagline-bg" -->
                    </div>
        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <!-- Bulgarian language -->
                    <div class="fix-8-12" data-lang="bg" style="display:none;">   <!-- edited to: data-lang="bg" -->
                        <h1 class="large ae-2">Нашата цел е да върнем ценности обратно на човечеството и социалното взаимодействие.</h1>
                    </div>
        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <!-- Bulgarian language -->
                    <div class="fix-12-12" data-lang="bg" style="display:none;">  <!-- edited to: data-lang="bg" -->
                        <div class="fix-6-12 left toLeft">
                            <h1 class="ae-1 small margin-bottom-2">Redd е всеки.</h1>
                            <p class="ae-2 large"><span class="opacity-8">Потребителите ни са съставени от всички цветове, религии и езици. С над 60 000 потребители, Redd ви дава инструментите за споделяне, помощ и възнаграждаване на хора и социални каузи за техните усилия.</span></p>
                            <a href="/about/" class="button red rounded crop margin-top-1 ae-3">Научете повече</a>
                        </div>
                    </div>
        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <div class="fix-12-12" data-lang="bg" style="display:none;">  <!-- edited to: data-lang="bg" -->
                        <div class="fix-5-12 left toRight">
                            <h1 class="ae-1 small margin-bottom-2">Redd е навсякъде.</h1>
                            <p class="ae-2 large"><span class="opacity-8">Понастоящем се използва в над 50 държави, а скоро ReddID ще ви позволи да подкрепяте, типвате (давате бакшиши) и дарявате на всеки, и във всички основни социално-медийни платформи.</span></p>
                            <a href="/technology/#redd-network" class="button red rounded crop margin-top-1 ae-3">Научете повече</a>
                        </div>
                    </div>
        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <div class="fix-12-12" data-lang="bg" style="display:none;">  <!-- edited to: data-lang="bg" -->
                        <div class="fix-6-12 left toLeft">
                            <h1 class="ae-1 small margin-bottom-2">Redd е грижовен.</h1>
                            <p class="ae-2 large"><span class="opacity-8">Повече от шест години, Redd е социална валута, която ви позволява да дарявате стойност и подкрепяте всеки човек или социална кауза по целия свят.</span></p>
                            <a href="/about/" class="button red rounded crop margin-top-1 ae-3">Научете повече</a>
                        </div>
                    </div>
        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <!-- Bulgarian language -->
                    <div class="fix-7-12" data-lang="bg" style="display:none;"> <!-- edited to: data-lang="bg" -->
                        <h1 class="ae-1 large margin-bottom-2">Redd сте вие.</h1>
                        <p class="largest light ae-2"><span class="opacity-8">Независимо дали сте организация, която иска да допринесе или човек, запален по нашето социално движение, свържете се с нас!</span></p>
                        <a href="assets/doc/Redd-Book.pdf" class="button large rounded margin-right-2 red ae-3 fromLeft" download>Прочетете Redd Book</a><a href="/join/" class="button large rounded white ae-4 fromCenter">Присъединете се към движението</a>
                    </div>
        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <!-- Bulgarian language -->
                    <div class="fix-10-12 left" data-lang="bg" style="display:none;"> <!-- edited to: data-lang="bg" -->
                        <h1 class="ae-1 large">Вижте по какво работим!</h1>
                        <ul class="flex later margin-top-4">
                            <li class="col-4-12 left ae-3 margin-bottom-3">
                                <h4 class="small margin-bottom-1 ae-4">ReddCoin</h4>
                                <div class="ae-5"><p class="small opacity-8">Дигиталната валута, която нашата общност използва, за да дава бакшиши - типва, да споделя и дарява.</p><a href="/technology/#redd-coin" class="button small red margin-left-0 ae-5 fromCenter">Научете повече</a></div>
                            </li>
                            <li class="col-4-12 left ae-4 margin-bottom-3">
                                <h4 class="small margin-bottom-1 ae-5">ReddNetwork</h4>
                                <div class="ae-6"><p class="small opacity-8">ReddCoin работи върху персонализирана блокчейн мрежа, която разработихме.</p><a href="/technology/" class="button small red margin-left-0 ae-5 fromCenter">Научете повече</a></div>
                            </li>
                            <li class="col-4-12 left ae-5 margin-bottom-3">
                                <h4 class="small margin-bottom-1 ae-6">ReddWallet</h4>
                                <div class="ae-7"><p class="small opacity-8">Приложение, което използваме за съхранение, изпращане и получаване на ReddCoin.</p><a href="/technology/#redd-wallet" class="button small red margin-left-0 ae-5 fromCenter">Изтеглете портфейлa</a></div>
                            </li>
                        </ul>
                        <ul class="flex later">
                            <li class="col-4-12 left ae-6 margin-bottom-3">
                                <h4 class="small margin-bottom-1 ae-4">ReddRewards</h4>
                                <div class="ae-5"><p class="small opacity-8">Печелете допълнителни ReddCoin монети, просто като ги съхранявате във вашия ReddWallet.</p><a href="/technology/#redd-rewards" class="button rounded small red margin-left-0 ae-5 fromCenter">Научете повече</a></div>
                            </li>
                            <li class="col-4-12 left ae-7 margin-bottom-3">
                                <h4 class="small margin-bottom-1 ae-5">ReddID</h4>
                                <div class="ae-6"><p class="small opacity-8">Унифициран потребителски идентификатор (ID), който ви позволява да типвате (давате бакшиши) и дарявате във всички основни социални платформи.</p><a class="button rounded small white white margin-left-0 ae-5 fromCenter">Очаквайте скоро</a></div>
                            </li>
                            <li class="col-4-12 left ae-8 margin-bottom-3">
                                <h4 class="small margin-bottom-1 ae-6">ReddFoundation</h4>
                                <div class="ae-7"><p class="small opacity-8">Ще се използва за подпомагане на различни социални инициативи по света.</p><a class="button rounded small white margin-left-0 ae-5 fromCenter">Очаквайте скоро</a></div>
                            </li>
                        </ul>
                    </div>
