...
<head>
    ...
    <base href="./">
    <title>Build with Redd | The Social Currency</title>
    <meta property="og:title" content="Build with Redd | The Social Currency" />
    <meta name="twitter:title" content="Build with Redd | The Social Currency" />
    ...
    <meta name="og:image" content="assets/img/rdd-socialpic-dev.jpg?p=6TmscY4a" />
    <meta name="twitter:image" content="assets/img/rdd-socialpic-dev.jpg?p=6TmscY4a" />
...
<!-- Fade Menu to white background on Scroll -->
<script>
...
<!-- Swop treatment on scroll down from top -->
<style>
  .panel.top {
