...
<head>
    ...
    <base href="/">
    <title>Join Redd | The Social Currency</title>
    <meta property="og:title" content="Join Redd | The Social Currency" />
    <meta name="twitter:title" content="Join Redd | The Social Currency" />
    ...
    <meta name="og:image" content="assets/img/rdd-socialpic-volunteer.jpg?p=6TmscY4a" />
    <meta name="twitter:image" content="assets/img/rdd-socialpic-volunteer.jpg?p=6TmscY4a" />
        ...
        <div class="fix-12-12" data-lang="en">
          <ul class="flex fixedSpaces">
            <li class="col-5-12 left margin-bottom-3">
              ...
              <a href="about.html" class="button red rounded crop margin-top-1 margin-right-2 ae-3 fromCenter">Learn about Redd</a><a href="assets/doc/Redd-Book.pdf" class="button white rounded margin-top-1 ae-3 fromCenter" download>Read the Redd Book</a>
            </li>
        ...
        <div class="fix-12-12" data-lang="de" style="display:none;">
          <ul class="flex fixedSpaces">
            <li class="col-5-12 left margin-bottom-3">
              ...
              <a href="about.html" class="button small red rounded crop margin-top-1 margin-right-2 ae-3 fromCenter">Erfahren Sie mehr über Redd</a><a href="assets/doc/Redd-Book.pdf" class="button small large rounded white margin-top-1 ae-3 fromCenter" download>Lesen Sie das Redd Book</a>
            </li>
            <li class="col-1-12"></li>
            <li class="col-6-12">
			<div class="form-55 fix-5-12">
        ...
        <div class="fix-12-12" data-lang="ko" style="display:none;">
          <ul class="flex fixedSpaces">
            <li class="col-5-12 left margin-bottom-3">
              ...
              <a href="about.html" class="button red rounded crop margin-top-1 margin-right-2 ae-3 fromCenter">Redd에 대해서 알아보기</a><a href="assets/doc/Redd-Book.pdf" class="button white rounded margin-top-1 ae-3 fromCenter" download>Redd Book 읽기</a>
            </li>
            <li class="col-1-12"></li>
            <li class="col-6-12">
			<div class="form-55 fix-5-12">
        ...
        <div class="fix-12-12" data-lang="ru" style="display:none;">
          <ul class="flex fixedSpaces">
            <li class="col-5-12 left margin-bottom-3">
              ...
              <a href="about.html" class="button red rounded crop margin-top-1 margin-right-2 ae-3 fromCenter">Узнайте о Redd</a><a href="assets/doc/Redd-Book.pdf" class="button white rounded margin-top-1 ae-3 fromCenter" download>Прочтите Redd Book</a>
            </li>
            <li class="col-1-12"></li>
            <li class="col-6-12">
			<div class="form-55 fix-5-12">
