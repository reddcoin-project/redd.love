...
<head>
  ...
  <meta name="description"
    content="Redd is a digital currency that aims to bring value back to humanity and social interaction." />
  ...
  <link rel="stylesheet" as="font"
    href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400;500;600;800&family=Rubik:wght@500&family=Material+Icons&display=swap" />
...
<style>
  ...
  <nav class="panel top">
    <div class="sections desktop">
      <div class="left"><a href="index.html" title="Redd"><svg style="width:158px;height:60px">
    ...
    <div class="sections compact hidden">
      <div class="left"><a href="#" title="Redd"><svg style="width:158px;height:60px">
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use>
          </svg></a></div>
...
<div class="dropdown top left center customDropdown" data-dropdown-id="dropdown-menu-ru">
  ...
  <nav class="sidebar" data-sidebar-id="1">
    ...
    <div class="content">
      <a href="#" class="logo"><svg width="132" height="50" style="margin:-5px;">
          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#logo"></use>
        </svg></a>
...
<div class="popup" data-popup-id="pu-kbs">
  ...
  <!-- Panel Bottom #12 -->
  <!-- English language -->
  <nav class="panel bottom" data-lang="en">
    <div class="sections desktop">
      <div class="left uppercase">We <svg style="width:27px;height:25px;margin-bottom:-3px;">
          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#redd-heart"></use>
        </svg> our community</div>
      <div class="center">
        <ul class="menu uppercase">
          ...
          <li><a href="press.html">Press Kit</a></li>
          <li>
            <div class="popupTrigger opacity-8" data-popup-id="contact">Donations</div>
          </li>
        </ul>
      </div>
      <div class="right">
        <ul class="menu crop">
          <li style="margin:0 5px 0 5px;"><a href="https://twitter.com/ProjectReddTW" target="_blank"><svg>
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#twitter"></use>
              </svg></a></li>
          <li style="margin:0 5px 0 5px;"><a href="https://www.youtube.com/ReddProject" target="_blank"><svg>
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#youtube"></use>
              </svg></a></li>
          <li style="margin:0 5px 0 5px;"><a href="https://medium.com/@techadept" target="_blank"><svg>
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#medium"></use>
              </svg></a></li>
          <li style="margin:0 5px 0 5px;"><a href="https://t.me/ReddcoinOfficial" target="_blank"><svg>
  ...
  <!-- Deutsch language -->
  <nav class="panel bottom" data-lang="de" style="display:none;">
    <div class="sections desktop">
      <div class="left uppercase">Wir <svg style="width:27px;height:25px;margin-bottom:-3px;">
          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#redd-heart"></use>
        </svg> euch</div>
      <div class="center">
        <ul class="menu uppercase">
          ...
          <li><a href="press.html">Pressemappe</a></li>
          <li>
            <div class="popupTrigger opacity-8" data-popup-id="contact">Spenden</div>
          </li>
        </ul>
      </div>
      <div class="right">
  ...
  <!-- Korean language -->
  <nav class="panel bottom" data-lang="ko" style="display:none;">
    <div class="sections desktop">
      <div class="left uppercase">우리는 <svg style="width:27px;height:25px;margin-bottom:-3px;">
          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#redd-heart"></use>
        </svg> 우리의 커뮤니티</div>
      <div class="center">
        <ul class="menu uppercase">
          ...
          <li><a href="press.html">보도자료</a></li>
          <li>
            <div class="popupTrigger opacity-8" data-popup-id="contact">기부</div>
          </li>
        </ul>
      </div>
      <div class="right">
            ...
            <ul class="flex fixedSpaces reverse">
              ...
              <li class="col-5-12 left" data-lang="en">
                <h2 class="margin-top-5 margin-bottom-2 ae-1 fromLeft">Donations</h1>
                  <p class="large ae-2 fromLeft"><span class="opacity-8">As Redd is now self-funded for all operations
                      following successful PoSV v2 activation, all donations sent to this address will be used for
                      charitable and community-oriented activities.</span></p>
                  <p class="large ae-2 fromLeft"><span class="opacity-8 break-word">If you really, really want to donate
                      to the team to buy them a drink or as a thank you, please send to
                      Ru6sDVdn4MhxXJauQ2GAJP4ozpPpmcDKdc.</span></p>
              </li>

              <!-- Deutsch language -->
              <li class="col-5-12 left" data-lang="de" style="display:none;">
                <h2 class="margin-top-4 margin-bottom-2 ae-1 fromLeft">Spenden</h1>
                  <p class="ae-2 fromLeft"><span class="opacity-8">Da Redd nach erfolgreicher Aktivierung von PoSV v2
                      nun für alle Operationen selbst finanziert wird, werden alle an diese Adresse gesendeten Spenden
                      für wohltätige und gemeinschaftsorientierte Aktivitäten verwendet.</span></p>
                  <p class="ae-2 fromLeft"><span class="opacity-8 break-word">Wenn Sie wirklich, wirklich an das Team
                      spenden möchten, um ihnen ein Getränk zu kaufen, oder als Dankeschön, senden Sie es bitte an
                      Ru6sDVdn4MhxXJauQ2GAJP4ozpPpmcDKdc.</span></p>
              </li>
              ...
              <li class="col-5-12 left" data-lang="ko" style="display:none;">
                <h2 class="margin-top-5 margin-bottom-2 ae-1 fromLeft">기부</h1>
                  <p class="large ae-2 fromLeft"><span class="opacity-8">Redd는 PoSV v2의 활성화에 성공한 후 모든 운영에 대해서 자체적으로
                      자금조달을 하고 있기 때문에 이 주소로 보내지는 모든 기부금은 자선 및 지역사회중심의 활동에 사용될 것입니다.</span></p>
                  <p class="large ae-2 fromLeft"><span class="opacity-8 break-word">여러분이 진심으로 팀에 대한 감사의 표시로 음료나 기부를
                      원하신다면 Ru6sDVdn4MhxXJauQ2GAJP4ozpPpmcDKdc 로 보내주세요.</span></p>
              </li>
